...
const PWAInstallBanner = () => {
    ...
    return (
        <>
            <div
                className="fixed top-0 inset-x-0 z-[10000] pointer-events-auto w-full px-3 py-3 sm:px-4 border-b border-white/20 shadow-md"
            ...
            <div className="h-[102px] sm:h-[68px]" aria-hidden="true" />
        </>
    );
};
